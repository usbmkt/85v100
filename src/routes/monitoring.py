...
def get_extractor_stats():
    ...
    try:
        stats = robust_content_extractor.get_stats()
        return jsonify({
            'success': True,
            'stats': stats
        })
    ...
    try:
        ...
        if content:
            ...
            try:
                ...
                validation = {"valid": True, "score": 0.8, "issues": []}
            ...
            result = {
                ...
                'metadata': metadata,
                'extractor_stats': robust_content_extractor.get_stats()
            }
        else:
            result = {
                'success': False,
        ...
        return jsonify({
            'success': False,
            'error': str(e),
            'extractor_stats': robust_content_extractor.get_stats() if 'robust_content_extractor' in locals() else {}
        }), 500
